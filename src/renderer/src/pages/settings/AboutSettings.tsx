...
import { IndicatorLight } from '@renderer/components'
...
const logger = loggerService.withContext('AboutSettings')
...
const AboutSettings: FC = () => {
  ...
  const onOpenDocs = () => {
    ...
    window.api.openWebsite(
      isChinese ? 'https://echoplayer.cc/docs' : 'https://echoplayer.cc/en/docs'
    )
  }
  ...
  return (
    <SettingContainer theme={theme}>
      <SettingGroup theme={theme}>
        ...
        <AboutHeader>
          <Row align="middle">
            <AvatarWrapper onClick={() => onOpenWebsite(APP_REPOSITORY)}>
            ...
            <VersionWrapper>
              ...
              <Tag
                onClick={() => onOpenWebsite(APP_RELEASES)}
                color="cyan"
          ...
          <>
            ...
            {testPlan && (
              <>
                ...
                <SettingRow>
                  <SettingRowTitle>
                    {t('settings.general.test_plan.version_options')}
                  </SettingRowTitle>
                  <Radio.Group
                    size="small"
                    buttonStyle="solid"
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite('https://echoplayer.cc')}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite(`${APP_REPOSITORY}/issues/new/choose`)}>
