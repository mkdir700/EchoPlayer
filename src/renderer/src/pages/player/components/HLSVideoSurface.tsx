 ...
 */
function HLSVideoSurface({ src, onLoadedMetadata, onError }: HLSVideoSurfaceProps) {
  ...
  return (
    <Surface
      ...
      tabIndex={0}
    >
      <HLSPlayer src={src} onLoadedMetadata={handleLoadedMetadata} onError={handleVideoError} />
