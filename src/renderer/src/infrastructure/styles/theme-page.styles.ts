import type { ThemeStyles } from '@renderer/infrastructure/types'
import type { GlobalToken } from 'antd'

import { createThemeAwareGlassEffect, themeStyles } from './theme'
...
> {
  return {
    ...
    // 毛玻璃效果 - 使用新的主题感知生成器
    glassEffect: createThemeAwareGlassEffect.auto(token, 'light'),
