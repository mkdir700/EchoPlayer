import { SubtitleBackgroundType, SubtitleDisplayMode, SubtitleFormat } from '@types'
...
export const BACKGROUND_TYPE_OPTIONS = [
  { type: SubtitleBackgroundType.TRANSPARENT, label: '完全透明', icon: '○' },
  { type: SubtitleBackgroundType.BLUR, label: '模糊背景', icon: '◐' },
  { type: SubtitleBackgroundType.SOLID_BLACK, label: '黑色背景', icon: '●' },
  { type: SubtitleBackgroundType.SOLID_GRAY, label: '灰色背景', icon: '◉' }
] as const
